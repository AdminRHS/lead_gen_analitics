const uk = {
  common: {
    ...
    unknown: 'Невідомо',
    anomalyTitle: 'Важливі зміни',
    anomalyWindow: 'порівняно з попереднім періодом у {days} днів'
  },
  filters: {
    country: 'Країна',
    source: 'Джерело',
  ...
  alerts: {
    ...
    metricSpike: '{metric} зросло на {value} відносно попереднього періоду',
    metricDip: '{metric} впало на {value} відносно попереднього періоду'
  },
  errors: {
